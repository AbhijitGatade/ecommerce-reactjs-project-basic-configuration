				...
				<div className="container">
					<div className="row">
						<div className="col-sm-7 col-md-9">
							<div id="colorlib-logo"><NavLink style={NavStyle}  to="/"><i class="fa-brands fa-opencart"></i> Footwear</NavLink></div>
						</div>
					...
					<div className="row">
						<div className="col-sm-12 text-left menu-1">
							<ul>
								...
								<li><NavLink style={NavStyle} className="nav-bar-link" to="/administration">administration</NavLink></li>
